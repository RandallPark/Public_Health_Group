...
<<<<<<< HEAD
  ...
  case when los_d = 1 then "1"
       ...
       when los_d = 8 then "8"
       when los_d = 9 then "9"
       when los_d = 10 then "10"
       when los_d = 11 then "11"
       when los_d = 12 then "12"
       when los_d = 13 then "13"
       when los_d = 14 then "14"
       when los_d = 15 then "15"
       when los_d = 16 then "16"
       when los_d = 17 then "17"
       when los_d = 18 then "18"
       when los_d = 19 then "19"
       when los_d = 20 then "20"
       when los_d = 21 then "21"
       when los_d = 22 then "22"
       when los_d = 23 then "23"
       when los_d = 24 then "24"
       when los_d = 25 then "25"
       when los_d = 26 then "26"
       when los_d = 27 then "27"
       when los_d = 28 then "28"
       when los_d = 29 then "29"
       when los_d = 30 then "30"
       when los_d = 31 then "Length of stay is between 31 and 45days"
       when los_d = 32 then "Length of stay is between 46 and 60days"
       when los_d = 33 then "Length of stay is between 61 and 90days"
       when los_d = 34 then "Length of stay is between 91 and 120 days"
       when los_d = 35 then "Length of stay is between 121 and 180 days"
       when los_d = 36 then "Length of stay is between 181 and 365 days"
       when los_d = 37 then "Length of stay is greater than 365 days"
  else "Undefined"
  end los_d_de
  ,arrests_d
  case when arrests_ = 0 then "NONE"
